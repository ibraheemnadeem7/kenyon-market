import { Camera, ChevronRight, Gift, Sparkles, TrendingDown } from "lucide-react";
    ...
    <section id="how" className="mx-auto max-w-[1200px] scroll-mt-28 px-4 py-24 text-center sm:py-32">
      ...
      <div className="mt-14 flex flex-col items-stretch gap-4 lg:flex-row lg:items-center lg:gap-0">
        {steps.map(({ Icon, title, body }, i) => (
          <Fragment key={title}>
            {i > 0 && (
              <ChevronRight className="mx-auto hidden size-5 shrink-0 text-ink lg:mx-3 lg:block" />
            )}
